...
const config = {
  ...
  // remember we said webpack sees everthing as modules and how different loaders
  // are responsible for different file types? Here is is where we implement them.
